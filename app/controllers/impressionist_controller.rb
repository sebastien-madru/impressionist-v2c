...
module ImpressionistController
  ...
  module InstanceMethods
    ...
    def media_user_id
      ...
      media_user_id = current_media_user ? current_media_user.id : nil rescue nil if media_user_id.blank?
      media_user_id
    end

    def contact_id
      contact_id = @contact ? @contact.id : nil rescue nil
      contact_id = current_contact ? current_contact.id : nil rescue nil if contact_id.blank?
      contact_id
    end
  end
end
